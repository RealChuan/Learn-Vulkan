...
private:
    ...
    {
        auto vertShaderCode = readFile("texture_dir/shader.vert.spv");
        auto fragShaderCode = readFile("texture_dir/shader.frag.spv");
    ...
    void createTextureImage()
    {
        ...
        stbi_uc *pixels = stbi_load("texture_dir/texture.jpg",
                                    &texWidth,
                                    &texHeight,
                                    &texChannels,
                                    STBI_rgb_alpha);
